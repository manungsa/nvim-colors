...
hi ErrorMsg term=standout ctermbg=DarkRed ctermfg=White guibg=#d61323
	\ guifg=lightgray
...
hi StatusLine term=NONE cterm=NONE ctermbg=gray ctermfg=black gui=NONE
	\ guifg=lightgray guibg=#3c5452
hi StatusLineNC term=NONE cterm=NONE ctermbg=black ctermfg=gray gui=NONE
...
hi Visual term=reverse cterm=NONE ctermbg=gray ctermfg=black gui=NONE
	\ guifg=lightgray guibg=#454565

...
hi Comment       term=bold           ctermfg=gray          guifg=darkgray
...
hi StatusLine    term=reverse,bold   cterm=reverse         gui=NONE       guifg=lightgray   guibg=#3c4452
...
hi Visual        term=reverse        cterm=reverse         gui=NONE       guifg=white       guibg=#555555
...
hi netrwExe      gui=bold            guifg=#27be31
